...
export const registrationApi = {
  ...
  toggleStatus: async (eventId) => {
    const response = await api.post(`/events/admin/registration/${eventId}/toggle`);
  ...
  setTimeline: async (eventId, timeline) => {
    const response = await api.put(`/events/admin/registration/${eventId}/timeline`, timeline);
    return response.data;
  },
  ...
  getStatus: async (eventId) => {
    const response = await api.get(`/events/admin/registration/${eventId}/status`);
    return response.data;
  },
  ...
  updateSettings: async (eventId, settings) => {
    const response = await api.put(`/events/admin/registration/${eventId}/settings`, settings);
    return response.data;
  },
  ...
  extendDeadline: async (eventId, extension) => {
    const response = await api.post(`/events/admin/registration/${eventId}/extend`, extension);
    return response.data;
  },
  ...
  getHistory: async (eventId) => {
    const response = await api.get(`/events/admin/registration/${eventId}/history`);
    return response.data;
  },
  ...
  validateRequirements: async (eventId) => {
    const response = await api.get(`/events/admin/registration/${eventId}/validate`);
    return response.data;
  }
};
