...
class ClientReferralService {
  ...
  /**
   * Create a new referral link for an event (client-side - dummy)
   */
  ...
  /**
   * Get all referral links for an event (client-side - dummy)
   */
  ...
  /**
   * Get referral statistics for an event (client-side - dummy)
   */
  ...
  /**
   * Get referral stats for a specific referral code (client-side - dummy)
   */
  ...
  /**
   * Get tracking data for a referral code (client-side - dummy)
   */
  ...
  /**
   * Delete a referral link (client-side - dummy)
   */
...
export default ClientReferralService;
