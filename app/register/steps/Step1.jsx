  ...
  return (
    <div className="h-full bg-white rounded border shadow-navy border-navy px-10 flex flex-col justify-between py-8 space-y-4">
            ...
            <DialogContent className="max-w-2xl max-h-[80vh] overflow-y-auto">
              ...
              <div className="space-y-6 mt-4">
                ...
                <div className="p-4 bg-purple-50 rounded-lg border-l-4 border-purple-500">
                  <h3 className="font-semibold text-purple-800 mb-2">📋 Category Selection</h3>
      ...
      <Card className="border-2 border-navy shadow-sm bg-white">
        <CardContent className="p-6 space-y-6 grid grid-cols-2 space-x-6">
          {/* Organization Name */}
          <div className="space-y-2">
            <Label htmlFor="name" className="text-navy font-semibold text-base">
              Organization Name *
            </Label>
            <Input
              type="text"
          ...
          {/* Organization Email */}
          <div className="space-y-2">
            <Label htmlFor="email" className="text-navy font-semibold text-base">
              Organization Email *
            </Label>
            <Input
              type="email"
          ...
          {/* Organization Phone */}
          <div className="space-y-2 ">
            <Label htmlFor="phone" className="text-navy font-semibold text-base">
              Organization Phone *
            </Label>
            <Input
              type="tel"
          ...
          {/* Alternative Phone */}
          <div className="space-y-2">
            <Label htmlFor="alternativePhone" className="text-navy font-semibold text-base">
          ...
          <div className="space-y-2 w-full">
            <Label className="text-navy font-semibold text-base">Select the Category *</Label>
            <Select value={formData.category} onValueChange={handleCategoryChange}>
              <SelectTrigger className="h-11 border-gray-300 focus:border-navy focus:ring-navy w-full">
                <SelectValue placeholder="Select the Category" />
              </SelectTrigger>
              <SelectContent>
                <SelectGroup>
                  <SelectLabel className="text-navy font-semibold">Organization Type</SelectLabel>
          ...
          {formData.category && (
            <div className="space-y-2 w-full">
              <Label className="text-navy font-semibold text-base">Select the Sub-Category *</Label>
              <Select value={formData.subCategory} onValueChange={handleSubCategoryChange}>
                ...
                <SelectContent>
                  <SelectGroup>
                    <SelectLabel className="text-navy font-semibold">Sub-Categories</SelectLabel>
