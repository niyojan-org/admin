...
export default function BasicInfoStep() {
  ...
  const removeTag = (tagToRemove) => {
    updateField(
      "tags",
      eventDraft.tags.filter((tag) => tag !== tagToRemove),
    );
  };
    ...
    return new Promise((resolve, reject) => {
      ...
      img.onload = () => {
        ...
        if (Math.abs(aspectRatio - targetRatio) > tolerance) {
          ...
          reject(
            "Image must have a 16:9 aspect ratio (recommended: 1920x1080 or 1280x720)",
          );
          return;
        }
  ...
  const handleBannerUpload = async (e) => {
    ...
    try {
      ...
      if (uploadResult?.url) {
        ...
        updateField("bannerImage", uploadResult.url);
    ...
    <div className="space-y-6">
              ...
              <div className="relative w-full rounded-lg overflow-hidden border group">
                <div className="relative aspect-video">
                  <img
                    ...
                    onError={(e) => {
                      e.target.src =
                        "https://placehold.co/1920x1080?text=Invalid+Image";
                    }}
                  />
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Configure event features and notifications
          </CardDescription>
        </CardHeader>
        <CardContent className="space-y-4">
          ...
          <div className="flex items-center justify-between">
            <div className="space-y-0.5">
              ...
              <p className="text-sm text-muted-foreground">
                Participants can register for multiple sessions
              </p>
            </div>
            <Switch
              checked={eventDraft.allowMultipleSessions}
              onCheckedChange={(checked) =>
                updateField("allowMultipleSessions", checked)
              }
            />
          </div>
          ...
          <div className="flex items-center justify-between">
            ...
            <Switch
              ...
              onCheckedChange={(checked) =>
                updateField("autoApproveParticipants", checked)
              }
            />
          </div>
          ...
          <div className="flex items-center justify-between">
            ...
            <Switch
              ...
              onCheckedChange={(checked) =>
                updateField("allowCoupons", checked)
              }
            />
          </div>
          ...
          <div className="flex items-center justify-between">
            ...
            <Switch
              ...
              onCheckedChange={(checked) =>
                updateField("allowReferrals", checked)
              }
            />
          </div>
          ...
          <div className="flex items-center justify-between">
            ...
            <Switch
              ...
              onCheckedChange={(checked) =>
                updateField("enableWhatsappNotifications", checked)
              }
            />
          </div>
        </CardContent>
