                    ...
                    <div className="grid grid-cols-2 gap-2 text-xs">
                        ...
                        {ticket.sold !== undefined && ticket.capacity !== undefined && (
                            <div className="text-muted-foreground col-span-1">
                                Available:{" "}
                                <span className="font-medium">{getAvailableCount()}</span>
                            </div>
                        )}
                    </div>
                )}
                            ...
                            <Tooltip>
                                <TooltipTrigger asChild>
                                    <div className="flex items-center gap-2">
                                        ...
                                        <TooltipContent>Toggle the ticket</TooltipContent>
                                    </div>
                                </TooltipTrigger>
                            </Tooltip>
                            ...
                            <Tooltip>
                                <TooltipTrigger asChild>
                                    <Button
                                        ...
                                        size="sm"
                                        onClick={() => onDelete(ticket)}
                                        className="hidden md:flex items-center gap-1 text-destructive hover:text-destructive hover:bg-destructive/10"
                                    >
