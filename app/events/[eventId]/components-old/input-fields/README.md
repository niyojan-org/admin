...
- `POST /events/admin/{eventId}/add-input-field`
- `PUT /events/admin/{eventId}/update-input-field/{fieldId}`
- `DELETE /events/admin/{eventId}/delete-input-field/{fieldId}`
- `PUT /events/admin/{eventId}/arrange-input-fields`
