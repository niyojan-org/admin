...
export default function Tickets({ eventId, className }) {
    ...
    const debouncedToggle = useCallback(
        debounce(async (ticketId, newStatus) => {
            try {
                await api.put(`/events/admin/ticket/${eventId}/toggle-active-ticket/${ticketId}`);
    ...
    const fetchTickets = async () => {
        try {
            setLoading(true);
            setError(null);
            const response = await api.get(`/events/admin/ticket/${eventId}`);
    ...
    const fetchTicketDetails = async (ticketId) => {
        try {
            ...
            const response = await api.get(`/events/admin/ticket/${eventId}/${ticketId}`);
    ...
    const handleCreateTicket = async (formData) => {
        try {
            ...
            const response = await api.post(`/events/admin/ticket/${eventId}`, formData);
    ...
    const handleUpdateTicket = async (ticketId, formData) => {
        try {
            ...
            const response = await api.put(`/events/admin/ticket/${eventId}/${ticketId}`, formData);
            setTickets(prev => prev.map(t =>
    ...
    const handleDeleteTicket = async (ticket) => {
        try {
            ...
            const response = await api.delete(`/events/admin/ticket/${eventId}/${ticket._id}`);
