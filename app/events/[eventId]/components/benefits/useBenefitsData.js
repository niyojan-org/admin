...
export const useBenefitsData = (eventId) => {
    ...
    const updateBenefit = async (benefitId, updateData) => {
        try {
            const response = await api.put(`/events/admin/benefits/${eventId}/${benefitId}`, updateData);
    ...
    const deleteBenefit = async (benefitId) => {
        try {
            const response = await api.delete(`/events/admin/benefits/${eventId}/${benefitId}`);
