          ...
          <DropdownMenu>
            ...
            <DropdownMenuContent align="end" className="w-48">
              <DropdownMenuItem asChild>
                <Link href={`/events/${event.slug}`} className="flex items-center w-full">
                  <IconEye className="h-4 w-4 mr-2" />
                  View Details
                </Link>
              </DropdownMenuItem>
              <DropdownMenuItem asChild>
                <Link href={`/events/${event.slug}/edit`} className="flex items-center w-full">
                  <IconEdit className="h-4 w-4 mr-2" />
                  Edit Event
                </Link>
              </DropdownMenuItem>
              <DropdownMenuItem asChild>
                <Link href={`/events/participants/${event.slug}`} className="flex items-center w-full">
              ...
              <DropdownMenuSeparator />
              <DropdownMenuItem asChild>
                <Link href={`/events/share/${event.slug}`} className="flex items-center w-full">
