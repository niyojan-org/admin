...
const MemberRemoveDialog = ({
  ...
  return (
    <AlertDialog open={open} onOpenChange={handleClose}>
      <AlertDialogContent className="sm:max-w-[500px] p-4">
        <AlertDialogHeader>
          ...
          <AlertDialogDescription asChild>
            <div className="space-y-3">
              ...
              <div className="flex items-center gap-4 p-4 bg-muted rounded-lg">
                ...
                <div className="flex-1 text-start">
                  ...
                  <div className="flex items-center gap-2 mt-1">
                    <Badge variant={getRoleBadgeVariant(memberRole)} className={'uppercase'}>
                      {memberRole}
                    </Badge>
                    <Badge variant={memberStatus === 'active' ? 'default' : 'destructive'} className={'uppercase'}>
                      {memberStatus}
                    </Badge>
                  </div>
                </div>
              ...
              <div className="space-y-2">
                <h4 className="font-medium text-sm">What happens when you remove this member:</h4>
                <ul className="text-sm text-muted-foreground space-y-1 text-start items-start flex-col">
