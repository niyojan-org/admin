...
export default function Coupons({ eventId }) {
    ...
    const debouncedToggle = useCallback(
        debounce(async (couponId, newStatus) => {
            try {
                await api.patch(`/event/admin/coupon/${eventId}/${couponId}/toggle`, { isActive: newStatus });
    ...
    const fetchCoupons = async () => {
        try {
            setLoading(true);
            setError(null);
            const response = await api.get(`/event/admin/coupon/${eventId}`);
    ...
    const fetchCouponAllowance = async () => {
        try {
            ...
            const response = await api.get(`/event/admin/coupon/${eventId}/allow-coupons`);
    ...
    const fetchCouponDetails = async (couponId) => {
        try {
            ...
            const response = await api.get(`/event/admin/coupon/${eventId}/${couponId}`);
    ...
    const handleCreateCoupon = async (formData) => {
        try {
            ...
            const response = await api.post(`/event/admin/coupon/${eventId}`, {
                ...formData,
                eventId
            });
    ...
    const handleDeleteCoupon = async (coupon) => {
        try {
            ...
            await api.delete(`/event/admin/coupon/${eventId}/${coupon._id}`);
