...
export function useReferralData(eventId) {
    ...
    const debouncedToggle = useCallback(
        debounce(async (referralId, newStatus) => {
            try {
                await api.patch(`/event/admin/referral/${eventId}/${referralId}/toggle`);
    ...
    const fetchReferrals = useCallback(async () => {
        try {
            setLoading(true);
            setError(null);
            const response = await api.get(`/event/admin/referral/${eventId}`);
    ...
    const fetchSystemStatus = useCallback(async () => {
        try {
            const response = await api.get(`/event/admin/referral/${eventId}/status`);
    ...
    const handleToggleSystem = async () => {
        try {
            ...
            const response = await api.patch(`/event/admin/referral/${eventId}/status`);
    ...
    const handleCreateReferral = async (formData) => {
        const response = await api.post(`/event/admin/referral/${eventId}`, formData);
    ...
    const handleUpdateReferral = async (referralId, formData) => {
        const response = await api.put(`/event/admin/referral/${eventId}/${referralId}`, formData);
        setReferrals(prev => prev.map(r =>
    ...
    const handleDeleteReferral = async (referral) => {
        const response = await api.delete(`/event/admin/referral/${eventId}/${referral._id}`);
